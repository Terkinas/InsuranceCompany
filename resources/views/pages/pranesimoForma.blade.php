...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <div class="my-6 md:my-2">
                        <div class="rounded bg-slate-600 max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
                            ...
                            <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                                <a href="/forma/automobilis/accident/form/{{$item->id}}" class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-indigo-600 bg-white hover:bg-indigo-50"> Pranešti </a>
                            </div>
                            @endif
     ...
     @if($item->verified)
        <div class="my-6 md:my-2">
                        <div class="rounded bg-slate-600 max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
                            ...
                            <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                                <a href="/forma/bustas/accident/form/{{$item->id}}" class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-indigo-600 bg-white hover:bg-indigo-50"> Pranešti </a>
                            </div>
  ...
  @endif
    @endforeach
    @else
    <p class="mx-24 my-12 text-xl text-slate-600">Nerasta būsto įrašų...</p>
    @endif
