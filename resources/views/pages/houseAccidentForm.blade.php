...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ env('APP_NAME') }} | Prašymo forma</title>
            ...
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                  <input disabled value="{{$house->squares}}" type="text" name="squares" id="squares" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="52">
                </div>
              </div>
              ...
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                  <input disabled value="{{$house->address}}" type="text" name="address" id="address" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="Ginkūnu g. 7">
                </div>
              </div>
            </div>

<form action='/forma/bustas/accident/form/submit/{{$house->id}}' method="post">
        @csrf
            <div>
              <label for="about" class="block text-sm font-medium text-gray-700"> Įvykio aprašymas </label>
              <div class="mt-1">
              ...
              <p class="mt-2 text-sm text-gray-500">Paminėkite visas detales įvykusias.</p>
            </div>
