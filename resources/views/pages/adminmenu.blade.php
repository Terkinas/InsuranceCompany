...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="/admin/clients/requests">Draudimo užsakymai</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="/admin/clients/accidents">Pranešti įvykiai</a></div>
        </div>
        ...
        <div class="ml-12">
            ...
            <a href="/admin/clients/accidents">
                <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
